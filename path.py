...
TWO_ATTACK_MOVE_NAMES = DATA_FOLDER + "two_attack_move_names.txt"
MIN_TWO_MAX_FIVE_ATTACK_MOVE_NAMES = DATA_FOLDER + "min_two_max_five_attack_move_names.txt"
MAX_THREE_ATTACK_MOVE_NAMES = DATA_FOLDER + "max_three_attack_move_names.txt"

ALL_NATURES = DATA_FOLDER + "all_natures.txt"
ALL_TYPES = DATA_FOLDER + "all_types.txt"
